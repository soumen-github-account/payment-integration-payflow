...
const ChatPayScreen = () => {
  ...
  const contact = contact_users.find(c => c.contactId === id);
  const [amount, setAmount] = useState("");
  const user_number = user_data.mobileNumber;

  if (!contact) {
    return <p className="text-white p-4">Contact not found</p>;
  }
          ...
          return (
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    <FaArrowRight className="bg-teal-700 p-2 text-3xl rounded-full" />
                </div>
